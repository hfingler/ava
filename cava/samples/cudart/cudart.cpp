...
CUresult CUDAAPI cuMemcpyDtoD(CUdeviceptr dstDevice, const void *srcDevice, size_t ByteCount) {
  // stubbed
  ava_unsupported;
}
...
void CUDAAPI cuProfilerStart(void) {
  // stubbed
  ava_unsupported;
}

void CUDAAPI cuProfilerStop(void) {
  // stubbed
  ava_unsupported;
}
