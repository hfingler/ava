...
ava_number(10);
ava_cxxflags(-I/usr/local/cuda/include -I${CMAKE_SOURCE_DIR}/cava/headers -I/usr/local/cuda/nvvm/include);
ava_libs(-L/usr/local/cuda/lib64 -lcudart -lcuda -lcublas -lcudnn -lcufft -lcurand -lcusparse -lcusolver -L/usr/local/cuda/nvvm/lib64 -lnvvm zmq nvidia-ml absl::flat_hash_map absl::hash);
