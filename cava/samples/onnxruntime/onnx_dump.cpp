...
ava_number(10);
ava_cxxflags(-I/usr/local/cuda-10.2/include -I${CMAKE_SOURCE_DIR}/cava/headers -I/usr/local/cuda-10.2/nvvm/include);
ava_libs(-L/usr/local/cuda-10.2/lib64 -lcudart -lcuda -lcublas -lcudnn -lcufft -lcurand -lcusparse -lcusolver -L/usr/local/cuda-10.2/nvvm/lib64 -lnvvm zmq nvidia-ml absl::flat_hash_map absl::hash);
ava_guestlib_srcs(cuda/nvvm_helper.cpp extensions/gpu_address_tracking.cpp);
ava_worker_srcs(extensions/cudart_10.1_utilities.cpp extensions/memory_server/client.cpp extensions/cudnn_optimization.cpp);
...
void **CUDARTAPI __cudaRegisterFatBinary(void *fatCubin) {
  ...
  if (ava_is_worker) {
    ...
    __helper_init_module((struct fatbin_wrapper *)fatCubin, ret, ava_metadata(NULL)->cur_module);
  }
}
